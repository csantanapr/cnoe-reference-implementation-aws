...
kubectl -n argocd rollout status --watch --timeout=300s statefulset/argo-cd-argocd-application-controller
kubectl -n argocd rollout status --watch --timeout=300s deployment/argo-cd-argocd-server
